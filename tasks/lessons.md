...
* **Правило**:
  ...
  - В строительном каталоге заблокированные предметы отображаются в состоянии "🔒 Нужен планшет" и кнопка покупки на них выключена. После разблокировки на планшете они становятся доступными для бесплатной установки (так как оплата уже произведена на планшете).
